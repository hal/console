...
/**
 * Presenter for subsystems w/o a specific implementation in HAL. Relies on the model browser to manage a (sub)tree of the
 * management model starting at the resource specified as place request parameter.
 * <p>
