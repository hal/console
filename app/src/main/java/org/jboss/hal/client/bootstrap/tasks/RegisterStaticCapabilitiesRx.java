...
public class RegisterStaticCapabilitiesRx implements BootstrapTaskRx {

    private final Environment environment;
    private final Capabilities capabilities;

    @Inject
    public RegisterStaticCapabilitiesRx(Environment environment, Capabilities capabilities) {
