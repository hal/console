...
public class ConfigurationColumn extends StaticItemColumn {
    ...
    public ConfigurationColumn(final Finder finder,
        ...
        super(finder, Ids.CONFIGURATION_COLUMN, Names.CONFIGURATION, asList(
                ...
                new StaticItem.Builder(Names.SYSTEM_PROPERTIES)
                        ...
                        .onPreview(new PreviewContent(Names.SYSTEM_PROPERTIES, resources.previews().systemProperties()))
                        .build()
        ));
    }
}
