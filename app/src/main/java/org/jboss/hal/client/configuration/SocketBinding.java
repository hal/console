...
enum SocketBinding {
    ...
    OUTBOUND_LOCAL(Ids.SOCKET_BINDING_GROUP_OUTBOUND_LOCAL, Names.OUTBOUND_LOCAL,
            ModelDescriptionConstants.LOCAL_DESTINATION_OUTBOUND_SOCKET_BINDING),
    OUTBOUND_REMOTE(Ids.SOCKET_BINDING_GROUP_OUTBOUND_REMOTE, Names.OUTBOUND_REMOTE,
