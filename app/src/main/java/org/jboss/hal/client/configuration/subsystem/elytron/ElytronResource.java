...
enum ElytronResource {
    ...
    AGGREGATE_EVIDENCE_DECODER(Ids.ELYTRON_AGGREGATE_EVIDENCE_DECODER,
            ModelDescriptionConstants.AGGREGATE_EVIDENCE_DECODER,
            AddressTemplates.AGGREGATE_EVIDENCE_DECODER_TEMPLATE, false),
    ...
    CUSTOM_EVIDENCE_DECODER(Ids.ELYTRON_CUSTOM_EVIDENCE_DECODER,
            ModelDescriptionConstants.CUSTOM_EVIDENCE_DECODER,
            AddressTemplates.CUSTOM_EVIDENCE_DECODER_TEMPLATE, false),
    ...
    X500_SUBJECT_EVIDENCE_DECODER(Ids.ELYTRON_X500_SUBJECT_EVIDENCE_DECODER,
            ModelDescriptionConstants.X500_SUBJECT_EVIDENCE_DECODER,
            AddressTemplates.X500_SUBJECT_EVIDENCE_DECODER_TEMPLATE, false),

    X509_SUBJECT_ALT_NAME_EVIDENCE_DECODER(Ids.ELYTRON_X509_SUBJECT_ALT_NAME_EVIDENCE_DECODER,
            ModelDescriptionConstants.X509_SUBJECT_ALT_NAME_EVIDENCE_DECODER,
            AddressTemplates.X509_SUBJECT_ALT_NAME_EVIDENCE_DECODER_TEMPLATE, false);
