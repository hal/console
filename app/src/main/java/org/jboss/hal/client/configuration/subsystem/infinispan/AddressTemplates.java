...
interface AddressTemplates {
    ...
    String CONNECTION_POOL_ADDRESS = REMOTE_CACHE_CONTAINER_ADDRESS + "/component=connection-pool";
    String SECURITY_ADDRESS = REMOTE_CACHE_CONTAINER_ADDRESS + "/component=security";
    String THREAD_POOL_ADDRESS = REMOTE_CACHE_CONTAINER_ADDRESS + "/thread-pool=async";
    ...
    AddressTemplate CONNECTION_POOL_TEMPLATE = AddressTemplate.of(CONNECTION_POOL_ADDRESS);
    AddressTemplate SECURITY_TEMPLATE = AddressTemplate.of(SECURITY_ADDRESS);
