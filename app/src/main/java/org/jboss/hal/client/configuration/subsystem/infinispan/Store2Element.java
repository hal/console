 ...
 */
class Store2Element implements IsElement<HTMLElement>, Attachable, HasPresenter<CachePresenter> {
    ...
    private final Map<Store, Write2Element> writeElements;
    private final Map<StoreTable, Form<ModelNode>> tableForms;
    private final HTMLElement root;
    private CachePresenter presenter;

    Store2Element(CacheType cacheType, MetadataRegistry metadataRegistry, Resources resources) {
        ...
        for (Store store : Store.values()) {
            ...
            Write2Element writeElement = new Write2Element(cacheType, store, metadataRegistry, resources);
