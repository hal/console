...
public abstract class JpaView extends MbuiViewImpl<JpaPresenter> implements JpaPresenter.MyView {
    ...
    public static JpaView create(final MbuiContext mbuiContext) {
        return new Mbui_JpaView(mbuiContext);
    }

    @MbuiElement("jpa-form") Form<ModelNode> form;

    JpaView(final MbuiContext mbuiContext) {
        super(mbuiContext);
    }
