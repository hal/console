...
public interface AddressTemplates {
    ...
    AddressTemplate PERIODIC_ROTATING_FILE_HANDLER_TEMPLATE = AddressTemplate.of(PERIODIC_ROTATING_FILE_HANDLER_ADDRESS);
    AddressTemplate PERIODIC_SIZE_ROTATING_FILE_HANDLER_TEMPLATE = AddressTemplate.of(PERIODIC_SIZE_ROTATING_FILE_HANDLER_ADDRESS);
