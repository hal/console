...
enum RemoteActiveMQSubResource {
    ...
    JGROUPS_DISCOVERY_GROUP(Ids.MESSAGING_JGROUPS_DISCOVERY_GROUP, Names.JGROUPS_DISCOVERY_GROUP,
            ModelDescriptionConstants.JGROUPS_DISCOVERY_GROUP, AddressTemplates.JGROUPS_DISCOVERY_GROUP_REMOTE_TEMPLATE),

    SOCKET_DISCOVERY_GROUP(Ids.MESSAGING_SOCKET_DISCOVERY_GROUP, Names.SOCKET_DISCOVERY_GROUP,
            ModelDescriptionConstants.SOCKET_DISCOVERY_GROUP, AddressTemplates.SOCKET_DISCOVERY_GROUP_REMOTE_TEMPLATE),
