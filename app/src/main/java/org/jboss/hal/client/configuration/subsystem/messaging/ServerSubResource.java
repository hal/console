...
enum ServerSubResource {
    ...
    JGROUPS_BROADCAST_GROUP(Ids.MESSAGING_JGROUPS_BROADCAST_GROUP, Names.JGROUPS_BROADCAST_GROUP,
            ModelDescriptionConstants.JGROUPS_BROADCAST_GROUP, AddressTemplates.JGROUPS_BROADCAST_GROUP_TEMPLATE),

    SOCKET_BROADCAST_GROUP(Ids.MESSAGING_SOCKET_BROADCAST_GROUP, Names.SOCKET_BROADCAST_GROUP,
            ModelDescriptionConstants.SOCKET_BROADCAST_GROUP, AddressTemplates.SOCKET_BROADCAST_GROUP_TEMPLATE),
    ...
    JGROUPS_DISCOVERY_GROUP(Ids.MESSAGING_JGROUPS_DISCOVERY_GROUP, Names.JGROUPS_DISCOVERY_GROUP,
            ModelDescriptionConstants.JGROUPS_DISCOVERY_GROUP, AddressTemplates.JGROUPS_DISCOVERY_GROUP_TEMPLATE),

    SOCKET_DISCOVERY_GROUP(Ids.MESSAGING_SOCKET_DISCOVERY_GROUP, Names.SOCKET_DISCOVERY_GROUP,
            ModelDescriptionConstants.SOCKET_DISCOVERY_GROUP, AddressTemplates.SOCKET_DISCOVERY_GROUP_TEMPLATE),
