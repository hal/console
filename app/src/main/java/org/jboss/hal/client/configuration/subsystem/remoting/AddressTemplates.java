...
interface AddressTemplates {
    ...
    String SASL_POLICY_EQ__POLICY = "/sasl-policy=policy";
    ...
    String CONNECTOR_SECURITY_POLICY_ADDRESS = CONNECTOR_SECURITY_ADDRESS + SASL_POLICY_EQ__POLICY;
    ...
    String SELECTED_CONNECTOR_SECURITY_POLICY_ADDRESS = SELECTED_CONNECTOR_SECURITY_ADDRESS + SASL_POLICY_EQ__POLICY;
    ...
    String HTTP_CONNECTOR_SECURITY_POLICY_ADDRESS = HTTP_CONNECTOR_SECURITY_ADDRESS + SASL_POLICY_EQ__POLICY;
    ...
    String SELECTED_HTTP_CONNECTOR_SECURITY_POLICY_ADDRESS = SELECTED_HTTP_CONNECTOR_SECURITY_ADDRESS + SASL_POLICY_EQ__POLICY;
