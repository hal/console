...
enum Listener {
    ...
    AJP(Ids.UNDERTOW_SERVER_AJP_LISTENER, Names.AJP_LISTENER, AJP_LISTENER), HTTP(Ids.UNDERTOW_SERVER_HTTP_LISTENER,
            Names.HTTP_LISTENER,
            HTTP_LISTENER), HTTPS(Ids.UNDERTOW_SERVER_HTTPS_LISTENER, Names.HTTPS_LISTENER, HTTPS_LISTENER);
