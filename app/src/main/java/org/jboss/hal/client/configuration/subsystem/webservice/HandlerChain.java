...
enum HandlerChain {
    ...
    PRE_HANDLER_CHAIN(Names.PRE_HANDLER_CHAIN, ModelDescriptionConstants.PRE_HANDLER_CHAIN), POST_HANDLER_CHAIN(
            Names.POST_HANDLER_CHAIN, ModelDescriptionConstants.POST_HANDLER_CHAIN),;
