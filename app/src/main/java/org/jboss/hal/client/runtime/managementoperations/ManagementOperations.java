...
class ManagementOperations extends NamedNode {
    ...
    enum ExecutionStatus {
        ...
        EXECUTING("executing", "The caller thread is actively executing"), AWAITING_OTHER_OPERATION("awaiting-other-operation",
                "The caller thread is blocking waiting for another operation to release the exclusive execution lock"), AWAITING_STABILITY(
                        "awaiting-stability",
                        "The caller thread has made changes to the service container and is waiting for the service container to stabilize"), COMPLETING(
                                "completing", "The operation is committed and is completing execution"), ROLLING_BACK(
