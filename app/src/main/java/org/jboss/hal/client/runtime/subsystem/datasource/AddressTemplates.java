...
interface AddressTemplates {
    ...
    String XA_DATA_SOURCE_DEPLOYMENT_ADDRESS = DEPLOYMENT_ADDRESS + DATA_SOURCE_SUBSYSTEM;
    String XA_DATA_SOURCE_SUBDEPLOYMENT_ADDRESS = SUBDEPLOYMENT_ADDRESS + DATA_SOURCE_SUBSYSTEM;
