...
public interface AddressTemplates {
    ...
    String MESSAGING_QUEUE_ADDRESS = MESSAGING_SUBSYSTEM_ADDRESS + SERVER_ADDRESS + "/queue=*";
    ...
    AddressTemplate MESSAGING_QUEUE_TEMPLATE = AddressTemplate.of(MESSAGING_QUEUE_ADDRESS);
