...
public class WebPreview extends PreviewContent<StaticItem> {

    @NonNls org.slf4j.Logger logger = LoggerFactory.getLogger(Previews.class);
    ...
    public WebPreview(final Dispatcher dispatcher, final StatementContext statementContext, final Resources resources) {
        ...
        dispatcher.execute(operation, result -> {
            ...
            noStatistics = new EmptyState.Builder(resources.constants().statisticsDisabledHeader())
                    .description(resources.messages().undertowStatisticsDisabled(profile))
