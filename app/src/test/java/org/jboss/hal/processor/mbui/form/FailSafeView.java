...
public abstract class FailSafeView extends MbuiViewImpl<MbuiTestPresenter> implements MbuiTestPresenter.MyView {

    public static FailSafeView create(final MbuiContext mbuiContext) {
        return null;
    }
