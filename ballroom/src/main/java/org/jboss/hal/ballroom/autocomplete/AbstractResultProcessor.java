...
/**
 * Abstract result processor which makes it easy to unit test the processor. If your result processor is really trivial and does
 * not need to be tested, there's no need to extend from this class.
 * <p>
 * The bulk of work should be placed into {@link #processToModel(String, ModelNode)} which can easily be unit tested. Whereas
 * {@link #asJson(List)} should contain no logic other than mapping the model to json.
 */
