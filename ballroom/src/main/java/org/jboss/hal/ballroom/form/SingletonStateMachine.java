...
/**
 * A state machine for singleton resources. Supports all {@link State states} and {@linkplain Operation operations}.
 * <p>
 * Please note: The singleton resource must be created outside the scope of this state machine. Once created the
 * {@link Operation#VIEW} operation is used to view the resource.
 * <p>
 *
 * <pre>
 *                   (0)----view()----+   +--------+
