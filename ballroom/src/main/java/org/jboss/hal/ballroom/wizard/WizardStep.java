...
public abstract class WizardStep<C, S extends Enum<S>> implements IsElement {
    ...
    /**
     * Subclasses should reset their state using this method. This method is called just before the wizard is opened. Opposed to
     * {@link #onShow(Object)} this method should be used to implement one-time initialization.
     */
