...
public class HostSelectionEvent extends GwtEvent<HostSelectionEvent.HostSelectionHandler> {
    ...
    public interface HostSelectionHandler extends EventHandler {
        ...
        void onHostSelected(HostSelectionEvent event);
    }


    private static final Type<HostSelectionHandler> TYPE = new Type<>();
    ...
    public HostSelectionEvent(final String host) {this.host = host;}
