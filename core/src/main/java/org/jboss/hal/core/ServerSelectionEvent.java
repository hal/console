...
public class ServerSelectionEvent extends GwtEvent<ServerSelectionEvent.ServerSelectionHandler> {
    ...
    public interface ServerSelectionHandler extends EventHandler {
        ...
        void onServerSelected(ServerSelectionEvent event);
    }


    private static final Type<ServerSelectionHandler> TYPE = new Type<>();
    ...
    public ServerSelectionEvent(final String server) {this.server = server;}
