...
/**
 * A text box item useful for add resource dialogs. The form item has {@link ModelDescriptionConstants#NAME} as name, is
 * required and does not allow expressions.
 */
