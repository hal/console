...
/**
 * The base presenter for HAL. Each presenter must extend from this presenter or one of its subclasses. Fires a
 * {@link HeaderModeEvent} as part of the {@link #onReveal()} method, if {@link #headerMode()} returns a non-null event.
 * <p>
 * The presenter calls {@link HalView#attach()} when it's {@linkplain #onReveal() revealed} and {@link HalView#detach()} when
 * it's {@linkplain #onHide() hidden}.
 */
