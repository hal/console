...
/**
 * Presenter for a top level category such as 'Homepage', 'Configuration' or 'Runtime'. The presenter fires a
 * {@link HeaderModeEvent} with its token in the {@link #onReveal()} method.
 */
