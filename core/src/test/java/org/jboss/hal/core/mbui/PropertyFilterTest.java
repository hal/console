...
public class PropertyFilterTest {
    ...
    public void allAttributes() {
        ...
        ModelNodeForm.Builder builder = new ModelNodeForm.Builder("allAttributes", resourceDescription);
    ...
    public void includes() {
        ResourceDescription resourceDescription = new ResourceDescriptionBuilder()
                .attributes("foo", "bar", "baz", "qux");
        ModelNodeForm.Builder builder = new ModelNodeForm.Builder("includes", resourceDescription)
                .include("foo", "bar");
        ImmutableSortedSet<Property> properties = new PropertyFilter(builder).filter();
