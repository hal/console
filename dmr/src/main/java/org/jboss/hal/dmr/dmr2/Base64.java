...
class Base64 {
    ...
    private static final byte[] _NATIVE_ALPHABET =
            {(byte) 'A', (byte) 'B', (byte) 'C', (byte) 'D', (byte) 'E', (byte) 'F', (byte) 'G', (byte) 'H', (byte) 'I',
                    ...
                    (byte) 'S',
                    (byte) 'T', (byte) 'U', (byte) 'V', (byte) 'W', (byte) 'X', (byte) 'Y', (byte) 'Z', (byte) 'a',
                    (byte) 'b',
     ...
     * notation. The
     * actual number of significant bytes in your array is given by <var>numSigBytes</var>. The array
     * <var>threeBytes</var>
     ...
     * serialized
     * or there is another error, the method will return <tt>null</tt>. The object is not GZip-compressed before being
     * encoded.
     *
    ...
    public static class OutputStream extends java.io.FilterOutputStream {
         ...
         * buffered
         * three at a time before the output stream actually gets a write() call. When decoding, bytes are buffered four
         * at a
         * time.
         *
