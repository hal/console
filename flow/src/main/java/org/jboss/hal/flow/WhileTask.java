...
/**
 * A task implementation that executes a {@linkplain Task task} as long as a {@linkplain Predicate predicate} evaluates to
 * {@code true}.
 * <p>
...
public class WhileTask<C extends FlowContext> implements Task<C> {
     ...
     * <p>
     * The task uses the default values from {@link While} and re-uses the {@linkplain FlowContext context} from the outer call
     * to {@link Flow#parallel(FlowContext, List)}, {@link Flow#sequential(FlowContext, List)} or
     * {@link Flow#while_(FlowContext, Task, Predicate)}.
     *
     ...
     * evaluates to {@code true}.
     * <p>
     * The task uses the default values from {@link While} and uses the given {@linkplain FlowContext context} for the execution
     * of the {@linkplain Task task}.
     *
