...
/**
 * Takes a set of types and a package and determines which of those types can be imported, and how to spell any of the types in
 * the set given those imports.
 *
...
public final class TypeSimplifier {
    ...
    /**
     * Returns the name of the package that the given type is in. If the type is in the default (unnamed) package then the name
     * is the empty string.
     */
