...
public interface Ids {
    ...
    String INSTALLER_ARTIFACT_CHANGES = "installer-artifact-changes";
    String INSTALLER_CHANNEL = "installer-channel";
    String INSTALLER_CHANNEL_ADD = "installer-channel-add";
    ...
    String INSTALLER_UPDATE_SERVER = "update-update-server";
    String INSTALLER_UPDATE_ZIP = "installer-update-zip";
    ...
    String UPDATE_SERVER_TABLE = "update-server-table";
