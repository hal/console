...
public interface Ids {
    ...
    // ------------------------------------------------------ common terms used in IDs below
    ...
    String BOOT_ERRORS_FORM = build(BOOT_ERRORS, FORM);
    String BOOT_ERRORS_OPERATION_COLUMN = build(BOOT_ERRORS, "operation", "column");
    String BOOT_ERRORS_TABLE = build(BOOT_ERRORS, TABLE);
    ...
    String CACHE_CONTAINER_ADD = build(CACHE_CONTAINER, ADD);
    String CACHE_CONTAINER_ENTRY = build(CACHE_CONTAINER, ENTRY);
    String CACHE_CONTAINER_FORM = build(CACHE_CONTAINER, FORM);
    String CACHE_CONTAINER_REFRESH = build(CACHE_CONTAINER, REFRESH);
    String CACHE_CONTAINER_THREAD_POOL = build(CACHE_CONTAINER, "thread-pool");
    String CACHE_CONTAINER_THREAD_POOL_ASYNC_OPERATIONS = build(CACHE_CONTAINER_THREAD_POOL, "async-operations");
    String CACHE_CONTAINER_THREAD_POOL_EXPIRATION = build(CACHE_CONTAINER_THREAD_POOL, "expiration");
    String CACHE_CONTAINER_THREAD_POOL_LISTENER = build(CACHE_CONTAINER_THREAD_POOL, "listener");
    String CACHE_CONTAINER_THREAD_POOL_PERSISTENCE = build(CACHE_CONTAINER_THREAD_POOL, "persistence");
    String CACHE_CONTAINER_THREAD_POOL_REMOTE_COMMAND = build(CACHE_CONTAINER_THREAD_POOL, "remote-command");
    String CACHE_CONTAINER_THREAD_POOL_STATE_TRANSFER = build(CACHE_CONTAINER_THREAD_POOL, "state-transfer");
    String CACHE_CONTAINER_THREAD_POOL_TRANSPORT = build(CACHE_CONTAINER_THREAD_POOL, "transport");
    String CACHE_CONTAINER_THREAD_POOLS_ENTRY = build(CACHE_CONTAINER_THREAD_POOL, "async-operations");
    String CACHE_CONTAINER_TRANSPORT = build(CACHE_CONTAINER, "transport");
    String CACHE_CONTAINER_TRANSPORT_ENTRY = build(CACHE_CONTAINER_TRANSPORT, ENTRY);
    String CACHE_CONTAINER_TRANSPORT_FORM = build(CACHE_CONTAINER_TRANSPORT, FORM);
    ...
    String CONFIGURATION_CHANGES = build(CONFIGURATION, "changes");
    String CONFIGURATION_SUBSYSTEM = "css";
    String CONTENT = "content";
    String CONTENT_ADD = build(CONTENT, ADD);
    String CONTENT_ADD_ACTIONS = build(CONTENT, ADD_ACTIONS);
    String CONTENT_NEW = build(CONTENT, "new");
    String CONTENT_EDITOR = build(CONTENT, "editor");
    String CONTENT_REFRESH = build(CONTENT, REFRESH);
    String CONTENT_SEARCH = build(CONTENT, SEARCH);
    String CONTENT_TAB = build(CONTENT, TAB);
    ...
    String CONTENT_UNMANAGED_ADD = build(CONTENT, UNMANAGED, ADD);
    String DATA_SOURCE_CONFIGURATION = build("ds", CONFIGURATION);
    String DATA_SOURCE_ADD = build(DATA_SOURCE_CONFIGURATION, ADD);
    String DATA_SOURCE_ADD_ACTIONS = build(DATA_SOURCE_CONFIGURATION, ADD_ACTIONS);
    String DATA_SOURCE_CONNECTION_FORM = build(DATA_SOURCE_CONFIGURATION, "connection", FORM);
    String DATA_SOURCE_DRIVER = "data-source-driver";
    String DATA_SOURCE_DRIVER_FORM = build(DATA_SOURCE_CONFIGURATION, "driver", FORM);
    String DATA_SOURCE_FORM = build(DATA_SOURCE_CONFIGURATION, FORM);
    String DATA_SOURCE_NAMES_FORM = build(DATA_SOURCE_CONFIGURATION, "names", FORM);
    String DATA_SOURCE_PROPERTIES_FORM = build(DATA_SOURCE_CONFIGURATION, "properties", FORM);
    String DATA_SOURCE_REFRESH = build(DATA_SOURCE_CONFIGURATION, REFRESH);
    String DATA_SOURCE_REVIEW_FORM = build(DATA_SOURCE_CONFIGURATION, "review", FORM);
    String DATA_SOURCE_RUNTIME = "ds-runtime";
    String DATA_SOURCE_RUNTIME_JDBC_FORM = build(DATA_SOURCE_RUNTIME, JDBC, FORM);
    String DATA_SOURCE_RUNTIME_JDBC_TAB = build(DATA_SOURCE_RUNTIME, JDBC, TAB);
    String DATA_SOURCE_RUNTIME_POOL_FORM = build(DATA_SOURCE_RUNTIME, POOL, FORM);
    String DATA_SOURCE_RUNTIME_POOL_TAB = build(DATA_SOURCE_RUNTIME, POOL, TAB);
    String DEPLOYMENT = "deployment";
    String DEPLOYMENT_ADD_ACTIONS = build(DEPLOYMENT, ADD_ACTIONS);
    String DEPLOYMENT_BROWSE_BY = "deployment-browse-by";
    String DEPLOYMENT_EMPTY_CREATE = build(DEPLOYMENT, "empty-create");
    String DEPLOYMENT_EMPTY_FORM = build(DEPLOYMENT, "empty", FORM);
    String DEPLOYMENT_REFRESH = build(DEPLOYMENT, REFRESH);
    String DEPLOYMENT_SERVER_GROUP = "deployment-sg";
    String DEPLOYMENT_TAB = build(DEPLOYMENT, TAB);
    String DEPLOYMENT_UNMANAGED_ADD = build(DEPLOYMENT, UNMANAGED, ADD);
    ...
    String EE = "ee";
    String EE_ATTRIBUTES_ENTRY = build(EE, ATTRIBUTES, ENTRY);
    String EE_ATTRIBUTES_FORM = build(EE, ATTRIBUTES, FORM);
    String EE_CONTEXT_SERVICE = build(EE, SERVICE, "context-service");
    String EE_DEFAULT_BINDINGS_ENTRY = build(EE, "default-bindings", ENTRY);
    String EE_DEFAULT_BINDINGS_FORM = build(EE, "default-bindings", FORM);
    String EE_GLOBAL_MODULES_ENTRY = build(EE, "global-modules", ENTRY);
    String EE_GLOBAL_MODULES_FORM = build(EE, "global-modules", FORM);
    String EE_GLOBAL_MODULES_TABLE = build(EE, "global-modules", TABLE);
    ...
    String EE_SERVICES_ENTRY = build(Ids.EE, "services", ENTRY);
    String EJB3 = "ejb3";
    String EJB3_APPLICATION_SECURITY_DOMAIN = build(EJB3, "app-security-domain");
    String EJB3_APPLICATION_SECURITY_DOMAIN_ADD = build(EJB3_APPLICATION_SECURITY_DOMAIN, ADD);
    String EJB3_APPLICATION_SECURITY_DOMAIN_ENTRY = build(EJB3_APPLICATION_SECURITY_DOMAIN, ENTRY);
    String EJB3_APPLICATION_SECURITY_DOMAIN_FORM = build(EJB3_APPLICATION_SECURITY_DOMAIN, FORM);
    String EJB3_APPLICATION_SECURITY_DOMAIN_TABLE = build(EJB3_APPLICATION_SECURITY_DOMAIN, TABLE);
    ...
    String ELYTRON_CUSTOM_POLICY_FORM = build(ELYTRON_CUSTOM_POLICY, FORM);
    ...
    String ELYTRON_JACC_POLICY_FORM = build(ELYTRON_JACC_POLICY, FORM);
    ...
    String ELYTRON_PERMISSIONS_ADD = build(ELYTRON_PERMISSIONS, ADD);
    String ELYTRON_PERMISSIONS_FORM = build(ELYTRON_PERMISSIONS, FORM);
    String ELYTRON_PERMISSIONS_PAGE = build(ELYTRON_PERMISSIONS, PAGE);
    String ELYTRON_PERMISSIONS_TABLE = build(ELYTRON_PERMISSIONS, TABLE);
    String ELYTRON_PERMISSION_MAPPINGS = build(ELYTRON, "permission-mappings");
    String ELYTRON_PERMISSION_MAPPINGS_ADD = build(ELYTRON_PERMISSION_MAPPINGS, ADD);
    String ELYTRON_PERMISSION_MAPPINGS_FORM = build(ELYTRON_PERMISSION_MAPPINGS, FORM);
    ...
    String ELYTRON_SIMPLE_PERMISSION_MAPPER_ADD = build(ELYTRON_SIMPLE_PERMISSION_MAPPER, ADD);
    String ELYTRON_SIMPLE_PERMISSION_MAPPER_FORM = build(ELYTRON_SIMPLE_PERMISSION_MAPPER, FORM);
    String ELYTRON_SIMPLE_PERMISSION_MAPPER_PAGE = build(ELYTRON_SIMPLE_PERMISSION_MAPPER, PAGE);
    String ELYTRON_SIMPLE_PERMISSION_MAPPER_TABLE = build(ELYTRON_SIMPLE_PERMISSION_MAPPER, TABLE);
    ...
    String ENDPOINT_REFRESH = build(ENDPOINT, REFRESH);
    String ENDPOINT_SELECT = build(ENDPOINT, "select");
    String ENDPOINT_STORAGE = build(STORAGE, ENDPOINT);
    String EXTENSION = "extension";
    String EXTENSION_ADD = build(EXTENSION, ADD);
    String EXTENSION_REVIEW_FORM = build(EXTENSION, "review", FORM);
    String EXTENSION_STORAGE = build(STORAGE, EXTENSION);
    String EXTENSION_URL_FORM = build(EXTENSION, "url", FORM);
    ...
    String HOST = "host";
    String HOST_REFRESH = build(HOST, REFRESH);
    ...
    String INTERFACE_ADD = build(INTERFACE, ADD);
    String INTERFACE_REFRESH = build(INTERFACE, REFRESH);
    String INVALIDATION_CACHE = "invalidation-cache";
    String JCA = "jca";
    String JCA_ARCHIVE_VALIDATION_FORM = build(JCA, "archive-validation", FORM);
    String JCA_ARCHIVE_VALIDATION_TAB = build(JCA, "archive-validation", TAB);
    String JCA_BEAN_VALIDATION_FORM = build(JCA, "bean-validation", FORM);
    String JCA_BEAN_VALIDATION_TAB = build(JCA, "bean-validation", TAB);
    String JCA_BOOTSTRAP_CONTEXT = build(JCA, "bootstrap-context");
    String JCA_BOOTSTRAP_CONTEXT_ADD = build(JCA_BOOTSTRAP_CONTEXT, ADD);
    String JCA_BOOTSTRAP_CONTEXT_ENTRY = build(JCA_BOOTSTRAP_CONTEXT, ENTRY);
    String JCA_BOOTSTRAP_CONTEXT_FORM = build(JCA_BOOTSTRAP_CONTEXT, FORM);
    String JCA_BOOTSTRAP_CONTEXT_TABLE = build(JCA_BOOTSTRAP_CONTEXT, TABLE);
    String JCA_CCM_FORM = build(JCA, "ccm", FORM);
    String JCA_CCM_TAB = build(JCA, "ccm", TAB);
    String JCA_CONFIGURATION_ENTRY = build(JCA, CONFIGURATION, ENTRY);
    String JCA_DISTRIBUTED_WORKMANAGER = build(JCA, "distributed-workmanager");
    String JCA_DISTRIBUTED_WORKMANAGER_ADD = build(JCA_DISTRIBUTED_WORKMANAGER, ADD);
    String JCA_DISTRIBUTED_WORKMANAGER_ENTRY = build(JCA_DISTRIBUTED_WORKMANAGER, ENTRY);
    String JCA_DISTRIBUTED_WORKMANAGER_FORM = build(JCA_DISTRIBUTED_WORKMANAGER, FORM);
    String JCA_DISTRIBUTED_WORKMANAGER_PAGE = build(JCA_DISTRIBUTED_WORKMANAGER, PAGE);
    String JCA_DISTRIBUTED_WORKMANAGER_TABLE = build(JCA_DISTRIBUTED_WORKMANAGER, TABLE);
    String JCA_THREAD_POOL = "thread-pool";
    String JCA_THREAD_POOL_ADD = build(JCA_THREAD_POOL, ADD);
    String JCA_THREAD_POOL_ATTRIBUTES_FORM = build(JCA_THREAD_POOL, ATTRIBUTES, FORM);
    String JCA_THREAD_POOL_ATTRIBUTES_TAB = build(JCA_THREAD_POOL, ATTRIBUTES, TAB);
    String JCA_THREAD_POOL_PAGE = build(JCA_THREAD_POOL, PAGE);
    String JCA_THREAD_POOL_SIZING_FORM = build(JCA_THREAD_POOL, "sizing", FORM);
    String JCA_THREAD_POOL_SIZING_TAB = build(JCA_THREAD_POOL, "sizing", TAB);
    String JCA_THREAD_POOL_TABLE = build(JCA_THREAD_POOL, TABLE);
    String JCA_TRACER_ENTRY = build(JCA, "tracer", ENTRY);
    String JCA_TRACER_FORM = build(JCA, "tracer", FORM);
    String JCA_WORKMANAGER = build(JCA, "workmanager");
    String JCA_WORKMANAGER_ADD = build(JCA_WORKMANAGER, ADD);
    String JCA_WORKMANAGER_ENTRY = build(JCA_WORKMANAGER, ENTRY);
    String JCA_WORKMANAGER_PAGE = build(JCA_WORKMANAGER, PAGE);
    String JCA_WORKMANAGER_TABLE = build(JCA_WORKMANAGER, TABLE);
    String JDBC_DRIVER = "jdbc-driver";
    String JDBC_DRIVER_ADD = build(JDBC_DRIVER, ADD);
    String JDBC_DRIVER_ADD_FORM = build(JDBC_DRIVER, ADD, FORM);
    String JDBC_DRIVER_REFRESH = build(JDBC_DRIVER, REFRESH);
    String JGROUPS = "jgroups";
    String JGROUPS_CHANNEL_CONFIG = build(JGROUPS, "channel");
    String JGROUPS_CHANNEL_ENTRY = build(JGROUPS, "channel", ENTRY);
    String JGROUPS_CHANNEL_FORK = "fork";
    String JGROUPS_CHANNEL_FORK_ENTRY = build(JGROUPS_CHANNEL_ENTRY, JGROUPS_CHANNEL_FORK, ENTRY);
    String JGROUPS_CHANNEL_FORK_PROTOCOL = "fork-protocol";
    String JGROUPS_ENTRY = build(JGROUPS, ENTRY);
    String JGROUPS_FORM = build(JGROUPS, FORM);
    ...
    String JGROUPS_STACK_ENTRY = build(JGROUPS, "stack", ENTRY);
    ...
    String JGROUPS_TRANSPORT_THREADPOOL_INTERNAL_TAB = build(JGROUPS, JGROUPS_TRANSPORT, "thread-pool-internal",
            TAB);
    String JGROUPS_TRANSPORT_THREADPOOL_OOB_FORM = build(JGROUPS, JGROUPS_TRANSPORT, "thread-pool-oob", FORM);
    String JGROUPS_TRANSPORT_THREADPOOL_OOB_TAB = build(JGROUPS, JGROUPS_TRANSPORT, "thread-pool-oob", TAB);
    String JGROUPS_TRANSPORT_THREADPOOL_TIMER_FORM = build(JGROUPS, JGROUPS_TRANSPORT, "thread-pool-timer",
            FORM);
    String JGROUPS_TRANSPORT_THREADPOOL_TIMER_TAB = build(JGROUPS, JGROUPS_TRANSPORT, "thread-pool-timer", TAB);
    String JMS_BRIDGE = "jms-bridge";
    String JMS_BRIDGE_ADD = build(JMS_BRIDGE, ADD);
    String JMS_BRIDGE_FORM = build(JMS_BRIDGE, FORM);
    String JMS_BRIDGE_REFRESH = build(JMS_BRIDGE, REFRESH);
    String JMS_BRIDGE_TAB = build(JMS_BRIDGE, TAB);
    String JMS_MESSAGE = "jms-message";
    String JMS_MESSAGE_CHANGE_PRIORITY = Ids.build(JMS_MESSAGE, "change-priority");
    String JMS_MESSAGE_CHANGE_PRIORITY_FORM = Ids.build(JMS_MESSAGE, "change-priority", FORM);
    String JMS_MESSAGE_EXPIRE = Ids.build(JMS_MESSAGE, "expire");
    String JMS_MESSAGE_MOVE = Ids.build(JMS_MESSAGE, "move");
    String JMS_MESSAGE_MOVE_FORM = Ids.build(JMS_MESSAGE, "move", FORM);
    ...
    String JMX = "jmx";
    String JMX_AUDIT_LOG_ENTRY = build(JMX, "audit-log", ENTRY);
    String JMX_AUDIT_LOG_FORM = build(JMX, "audit-log", FORM);
    String JMX_CONFIGURATION_ENTRY = build(JMX, CONFIGURATION, ENTRY);
    String JMX_CONFIGURATION_FORM = build(JMX, CONFIGURATION, FORM);
    String JMX_REMOTING_CONNECTOR_ENTRY = build(JMX, "remoting-connector", ENTRY);
    String JMX_REMOTING_CONNECTOR_FORM = build(JMX, "remoting-connector", FORM);
    String JNDI = "jndi";
    ...
    String JOB_REFRESH = build(JOB, REFRESH);
    String JPA_RUNTIME = "jpa-runtime";
    String JPA_RUNTIME_COLLECTION_ENTRY = build(JPA_RUNTIME, "collection", ENTRY);
    String JPA_RUNTIME_ENTITY_CACHE_ENTRY = build(JPA_RUNTIME, "entity-cache", ENTRY);
    String JPA_RUNTIME_ENTITY_ENTRY = build(JPA_RUNTIME, "entity", ENTRY);
    String JPA_RUNTIME_MAIN_ATTRIBUTES_ENTRY = build(JPA_RUNTIME, "main", ATTRIBUTES, ENTRY);
    String JPA_RUNTIME_QUERY_CACHE_ENTRY = build(JPA_RUNTIME, "query-cache", ENTRY);
    String LOCAL_CACHE = "local-cache";
    String LOG_FILE = "lf";
    String LOG_FILE_EDITOR = build(LOG_FILE, "editor");
    String LOG_FILE_REFRESH = build(LOG_FILE, REFRESH);
    String LOG_FILE_SEARCH = build(LOG_FILE, SEARCH);
    String LOGGING = "logging";
    String LOGGING_CONFIGURATION = build("logging", CONFIGURATION);
    String LOGGING_PROFILE = "logging-profile";
    String LOGGING_PROFILE_ADD = build(LOGGING_PROFILE, ADD);
    String MACRO = "macro";
    String MACRO_EDITOR = build(MACRO, "editor");
    String MACRO_LIST = build(MACRO, "list");
    String MACRO_OPTIONS = build(MACRO, "options");
    String MACRO_STORAGE = build(STORAGE, MACRO);
    String MAIL_SERVER = "mail-server";
    String MAIL_SERVER_DIALOG = build(MAIL_SERVER, ADD, FORM);
    String MAIL_SERVER_ENTRY = build(MAIL_SERVER, ENTRY);
    String MAIL_SERVER_FORM = build(MAIL_SERVER, FORM);
    String MAIL_SERVER_TABLE = build(MAIL_SERVER, TABLE);
    String MAIL_SESSION = "mail-session";
    String MAIL_SESSION_ADD = build(MAIL_SESSION, ADD);
    String MAIL_SESSION_DIALOG = build(MAIL_SESSION, FORM);
    String MAIL_SESSION_ENTRY = build(MAIL_SESSION, ENTRY);
    String MAIL_SESSION_FORM = build(MAIL_SESSION, FORM);
    String MAIL_SESSION_REFRESH = build(MAIL_SESSION, REFRESH);
    ...
    String MESSAGING_SECURITY_SETTING_ROLE_ADD = build(MESSAGING_SECURITY_SETTING_ROLE, ADD);
    String MESSAGING_SECURITY_SETTING_ROLE_ENTRY = build(MESSAGING_SECURITY_SETTING_ROLE, ENTRY);
    String MESSAGING_SECURITY_SETTING_ROLE_FORM = build(MESSAGING_SECURITY_SETTING_ROLE, FORM);
    String MESSAGING_SECURITY_SETTING_ROLE_TABLE = build(MESSAGING_SECURITY_SETTING_ROLE, TABLE);
    String MESSAGING_SERVER = "msg-server";
    String MESSAGING_SERVER_ADD = build(MESSAGING_SERVER, ADD);
    String MESSAGING_SERVER_CLUSTERING = build(MESSAGING_SERVER, "clustering");
    String MESSAGING_SERVER_CONFIGURATION = "msg-server-c";
    String MESSAGING_SERVER_CONFIGURATION_REFRESH = build(MESSAGING_SERVER_CONFIGURATION, REFRESH);
    ...
    String MESSAGING_SERVER_DESTINATION_REFRESH = build(MESSAGING_SERVER_DESTINATION, REFRESH);
    String MESSAGING_SERVER_HA_POLICY = build(MESSAGING_SERVER, "ha-policy");
    String MESSAGING_SERVER_RUNTIME = "msg-server-r";
    String MESSAGING_SERVER_RUNTIME_REFRESH = build(MESSAGING_SERVER_RUNTIME, REFRESH);
    ...
    String MESSAGING_SERVER_JOURNAL_DIRECTORY_FORM = build(MESSAGING_SERVER, "journal-directory", FORM);
    String MESSAGING_SERVER_PAGING_DIRECTORY = build(MESSAGING_SERVER, "paging-directory");
    String MESSAGING_SERVER_PAGING_DIRECTORY_FORM = build(MESSAGING_SERVER, "paging-directory", FORM);
    String MESSAGING_SERVER_BINDING_DIRECTORY = build(MESSAGING_SERVER, "bindings-directory");
    String MESSAGING_SERVER_BINDING_DIRECTORY_FORM = build(MESSAGING_SERVER, "bindings-directory", FORM);
    ...
    String MODEL_BROWSER_CREATE_SINGLETON_FORM = build(MODEL_BROWSER, "create-singleton", FORM);
    ...
    String PATCHES_REFRESH = build(PATCHING, REFRESH);
    String PATCHING_DOMAIN = "patching-domain";
    String PREVIEW_ID = build(FINDER, "preview");
    String PROFILE = "profile";
    String PROFILE_ADD = build(PROFILE, ADD);
    String PROFILE_CLONE = build(PROFILE, "clone");
    String PROFILE_REFRESH = build(PROFILE, REFRESH);
    String REMOTING = "remoting";
    String REMOTING_CONNECTOR_FORM = build(REMOTING, "connector", FORM);
    String REMOTING_CONNECTOR_SECURITY_FORM = build(REMOTING, "connector-security", FORM);
    String REMOTING_CONNECTOR_SECURITY_POLICY_FORM = build(REMOTING, "connector-security-policy", FORM);
    String REMOTING_CONNECTOR_SECURITY_POLICY_TAB = build(REMOTING, "connector-security-policy", TAB);
    String REMOTING_CONNECTOR_SECURITY_TAB = build(REMOTING, "connector-security", TAB);
    String REMOTING_CONNECTOR_TAB = build(REMOTING, "connector", TAB);
    String REMOTING_HTTP_CONNECTOR_FORM = build(REMOTING, "http-connector", FORM);
    String REMOTING_HTTP_CONNECTOR_SECURITY_FORM = build(REMOTING, "http-connector-security", FORM);
    String REMOTING_HTTP_CONNECTOR_SECURITY_POLICY_FORM = build(REMOTING, "http-connector-security-policy",
            FORM);
    String REMOTING_HTTP_CONNECTOR_SECURITY_POLICY_TAB = build(REMOTING, "http-connector-security-policy", TAB);
    String REMOTING_HTTP_CONNECTOR_SECURITY_TAB = build(REMOTING, "http-connector-security", TAB);
    String REMOTING_HTTP_CONNECTOR_TAB = build(REMOTING, "http-connector", TAB);
    String REPLICATED_CACHE = "replicated-cache";
    String RESOLVE_EXPRESSION = "resolve-expression";
    String RESOLVE_EXPRESSION_FORM = build(RESOLVE_EXPRESSION, FORM);
    String RESOURCE_ADAPTER = "resource-adapter";
    String RESOURCE_ADAPTER_ADD = build(RESOURCE_ADAPTER, ADD);
    String RESOURCE_ADAPTER_ADMIN_OBJECT_ADD = build(RESOURCE_ADAPTER, "admin-object", ADD);
    String RESOURCE_ADAPTER_CONNECTION_DEFINITION_ADD = build(RESOURCE_ADAPTER, "connection-definition", ADD);
    String RESOURCE_ADAPTER_FORM = build(RESOURCE_ADAPTER, FORM);
    String REST_RESOURCE = "rest-rsc";
    String REST_RESOURCE_REFRESH = build(REST_RESOURCE, REFRESH);
    String REST_RESOURCE_PATH_PARAM_FORM = build(REST_RESOURCE, "path-param", FORM);
    String ROLE = "role";
    String ROLE_ADD = build(ROLE, ADD);
    String ROLE_HOST_SCOPED_ADD = build(ROLE, HOST, ADD);
    String ROLE_HOST_SCOPED_FORM = build(ROLE, HOST, FORM);
    String ROLE_MAPPING_FORM = build("role-mapping", FORM);
    String ROLE_REFRESH = build(ROLE, REFRESH);
    String ROLE_SERVER_GROUP_SCOPED_ADD = build(ROLE, "server-group", ADD);
    String ROLE_SERVER_GROUP_SCOPED_FORM = build(ROLE, "server-group", FORM);
    String ROOT_CONTAINER = "hal-root-container";
    String RUNTIME_SUBSYSTEM = "rss";
    String SECURITY_DOMAIN = "security-domain";
    String SECURITY_DOMAIN_ACL_MODULE_ADD = build(SECURITY_DOMAIN, "acl", ADD);
    String SECURITY_DOMAIN_ADD = build(SECURITY_DOMAIN, ADD);
    String SECURITY_DOMAIN_AUDIT_ADD = build(SECURITY_DOMAIN, "provider", ADD);
    String SECURITY_DOMAIN_AUTHENTICATION_ADD = build(SECURITY_DOMAIN, "authentication", ADD);
    String SECURITY_DOMAIN_AUTHORIZATION_ADD = build(SECURITY_DOMAIN, "authorization", ADD);
    String SECURITY_DOMAIN_MAPPING_ADD = build(SECURITY_DOMAIN, "mapping", ADD);
    String SECURITY_DOMAIN_TRUST_MODULE_ADD = build(SECURITY_DOMAIN, "identity-trust", ADD);
    String SERVER = "server";
    String SERVER_ADD = build(SERVER, ADD);
    String SERVER_GROUP = "server-group";
    String SERVER_GROUP_ADD = build(SERVER_GROUP, ADD);
    String SERVER_GROUP_DEPLOYMENT = "server-group-deployment";
    String SERVER_GROUP_DEPLOYMENT_ADD = build(SERVER_GROUP_DEPLOYMENT, ADD);
    String SERVER_GROUP_DEPLOYMENT_ADD_ACTIONS = build(SERVER_GROUP_DEPLOYMENT, ADD_ACTIONS);
    String SERVER_GROUP_DEPLOYMENT_ENABLE = build(SERVER_GROUP_DEPLOYMENT, "enable");
    String SERVER_GROUP_DEPLOYMENT_REFRESH = build(SERVER_GROUP_DEPLOYMENT, REFRESH);
    String SERVER_GROUP_DEPLOYMENT_TABLE = build(SERVER_GROUP_DEPLOYMENT, TABLE);
    String SERVER_GROUP_DEPLOYMENT_UNMANAGED_ADD = build(SERVER_GROUP_DEPLOYMENT, UNMANAGED, ADD);
    ...
    String SERVER_STATUS_BOOTSTRAP_ENTRY = build(SERVER_RUNTIME, "bootstrap", ENTRY);
    String SERVER_STATUS_MAIN_ATTRIBUTES_ENTRY = build(SERVER_RUNTIME, "main-attributes", ENTRY);
    String SERVER_STATUS_SYSTEM_PROPERTIES_ENTRY = build(SERVER_RUNTIME, "system-properties", ENTRY);
    String SERVER_URL = "server-url";
    String SERVER_URL_FORM = build(SERVER_URL, FORM);
    String SERVER_URL_STORAGE = build(STORAGE, SERVER_URL);
    String SETTINGS_FORM = "settings-form";
    String SOCKET_BINDING_GROUP = "socket-binding-group";
    String SOCKET_BINDING_GROUP_ADD = build(SOCKET_BINDING_GROUP, ADD);
    ...
    String TLC = "tlc";
    String TLC_ACCESS_CONTROL = build(TLC, "access-control");
    String TLC_CONFIGURATION = build("tlc", CONFIGURATION);
    String TLC_DEPLOYMENTS = build(TLC, "deployments");
    String TLC_HOMEPAGE = build(TLC, "homepage");
    String TLC_MANAGEMENT = build(TLC, "management");
    String TLC_PATCHING = build(TLC, "patching");
    String TLC_RUNTIME = build(TLC, "runtime");
    String TOOLBAR = "toolbar";
    String TOOLBAR_FILTER = build(TOOLBAR, "filter");
    String TOOLBAR_ACTION_DROPDOWN = build(TOOLBAR, "action-dropdown");
    String TRANSACTION = "transaction";
    String TRANSACTION_PARTICIPANTS_PAGE = build(TRANSACTION, PARTICIPANTS, PAGE);
    String UNDERTOW_APP_SECURITY_DOMAIN = "undertow-application-security-domain";
    String UNDERTOW_APP_SECURITY_DOMAIN_ADD = build(UNDERTOW_APP_SECURITY_DOMAIN, ADD);
    String UNDERTOW_APP_SECURITY_DOMAIN_FORM = build(UNDERTOW_APP_SECURITY_DOMAIN, FORM);
    String UNDERTOW_APP_SECURITY_DOMAIN_REFRESH = build(UNDERTOW_APP_SECURITY_DOMAIN, REFRESH);
    String UNDERTOW_APP_SECURITY_DOMAIN_TAB = build(UNDERTOW_APP_SECURITY_DOMAIN, TABLE);
    String UNDERTOW_GLOBAL_SETTINGS = "undertow-global-settings";
    String UNDERTOW_LISTENER_REFRESH = build("undertow-listener", REFRESH);
    ...
    String UNDERTOW_HOST_ADD = build(UNDERTOW_HOST, ADD);
    String UNDERTOW_HOST_ATTRIBUTES_FORM = build(UNDERTOW_HOST, FORM);
    String UNDERTOW_HOST_ATTRIBUTES_TAB = build(UNDERTOW_HOST, TAB);
    String UNDERTOW_HOST_ENTRY = build(UNDERTOW_HOST, ENTRY);
    String UNDERTOW_HOST_FILTER_REF = build(UNDERTOW_HOST, "filter-ref");
    String UNDERTOW_HOST_FILTER_REF_ADD = build(UNDERTOW_HOST_FILTER_REF, ADD);
    String UNDERTOW_HOST_FILTER_REF_FORM = build(UNDERTOW_HOST_FILTER_REF, FORM);
    String UNDERTOW_HOST_FILTER_REF_PAGE = build(UNDERTOW_HOST_FILTER_REF, PAGE);
    String UNDERTOW_HOST_FILTER_REF_TABLE = build(UNDERTOW_HOST_FILTER_REF, TABLE);
    String UNDERTOW_HOST_HTTP_INVOKER = build(UNDERTOW_HOST, "http-invoker");
    String UNDERTOW_HOST_LOCATION_ADD = build(UNDERTOW_HOST, LOCATION, ADD);
    String UNDERTOW_HOST_LOCATION_FILTER_REF = build(UNDERTOW_HOST, LOCATION, "filter-ref");
    String UNDERTOW_HOST_LOCATION_FILTER_REF_ADD = build(UNDERTOW_HOST_LOCATION_FILTER_REF, ADD);
    String UNDERTOW_HOST_LOCATION_FILTER_REF_FORM = build(UNDERTOW_HOST_LOCATION_FILTER_REF, FORM);
    String UNDERTOW_HOST_LOCATION_FILTER_REF_PAGE = build(UNDERTOW_HOST_LOCATION_FILTER_REF, PAGE);
    String UNDERTOW_HOST_LOCATION_FILTER_REF_TABLE = build(UNDERTOW_HOST_LOCATION_FILTER_REF, TABLE);
    String UNDERTOW_HOST_LOCATION = build(UNDERTOW_HOST, LOCATION);
    String UNDERTOW_HOST_LOCATION_FORM = build(UNDERTOW_HOST_LOCATION, FORM);
    String UNDERTOW_HOST_LOCATION_PAGE = build(UNDERTOW_HOST_LOCATION, PAGE);
    String UNDERTOW_HOST_LOCATION_TABLE = build(UNDERTOW_HOST_LOCATION, TABLE);
    String UNDERTOW_HOST_MAIN_PAGE = build(UNDERTOW_HOST, "main", PAGE);
    String UNDERTOW_HOST_SINGLE_SIGN_ON = build(UNDERTOW_HOST, "single-sign-on");
    String UNDERTOW_HOST_TABLE = build(UNDERTOW_HOST, TABLE);
    String UNDERTOW_MODCLUSTER = build("undertow-modcluster");
    String UNDERTOW_MODCLUSTER_BALANCER_NODE_CONTEXT_REFRESH = build(UNDERTOW_MODCLUSTER, "balancer", "node", "context",
            REFRESH);
    String UNDERTOW_MODCLUSTER_BALANCER_NODE_REFRESH = build(UNDERTOW_MODCLUSTER, "balancer", "node", REFRESH);
    String UNDERTOW_MODCLUSTER_BALANCER_REFRESH = build(UNDERTOW_MODCLUSTER, "balancer", REFRESH);
    String UNDERTOW_MODCLUSTER_REFRESH = build(UNDERTOW_MODCLUSTER, REFRESH);
    String UNDERTOW_RESPONSE_HEADER_ADD = build("undertow-response-header", ADD);
    ...
    String UNDERTOW_RUNTIME_REFRESH = build("undertow-runtime-deployment", REFRESH);
    ...
    String UNDERTOW_SERVER_ADD = build(UNDERTOW_SERVER, ADD);
    String UNDERTOW_SERVER_AJP_LISTENER = build(UNDERTOW_SERVER, "ajp-listener");
    String UNDERTOW_SERVER_CONFIGURATION_ENTRY = build(UNDERTOW_SERVER, CONFIGURATION, ENTRY);
    String UNDERTOW_SERVER_CONFIGURATION_FORM = build(UNDERTOW_SERVER, CONFIGURATION, FORM);
    ...
    String UNDERTOW_SERVER_LISTENER_ENTRY = build(UNDERTOW_SERVER, "listener", ENTRY);
    String UNDERTOW_SERVER_REFRESH = build(UNDERTOW_SERVER, REFRESH);
    String UNDERTOW_SERVLET_CONTAINER = "undertow-servlet-container";
    String UNDERTOW_SERVLET_CONTAINER_ADD = build(UNDERTOW_SERVLET_CONTAINER, ADD);
    ...
    String UNDERTOW_SERVLET_CONTAINER_MIME_MAPPING_FORM = build(UNDERTOW_SERVLET_CONTAINER, "mime-mapping",
            FORM);
    String UNDERTOW_SERVLET_CONTAINER_MIME_MAPPING_TAB = build(UNDERTOW_SERVLET_CONTAINER, "mime-mapping", TAB);
    String UNDERTOW_SERVLET_CONTAINER_REFRESH = build(UNDERTOW_SERVLET_CONTAINER, REFRESH);
    ...
    String UNDERTOW_SERVLET_CONTAINER_WELCOME_FILE_FORM = build(UNDERTOW_SERVLET_CONTAINER, "welcome-file",
            FORM);
    String UNDERTOW_SERVLET_CONTAINER_WELCOME_FILE_TAB = build(UNDERTOW_SERVLET_CONTAINER, "welcome-file", TAB);
    String UNDERTOW_SETTINGS = "undertow-settings";
    String UNDERTOW_SINGLE_SIGN_ON = "undertow-single-sign-on";
    String UNDERTOW_SINGLE_SIGN_ON_ADD = build(UNDERTOW_SINGLE_SIGN_ON, ADD);
    String UNDERTOW_SINGLE_SIGN_ON_FORM = build(UNDERTOW_SINGLE_SIGN_ON, FORM);
    String UNDERTOW_SINGLE_SIGN_ON_TAB = build(UNDERTOW_SINGLE_SIGN_ON, TABLE);
    String UNMANAGED_FORM = build(UNMANAGED, FORM);
    String UPLOAD = "upload";
    String UPLOAD_FILE_INPUT = build(UPLOAD, "file-input");
    String UPLOAD_NAMES_FORM = build(UPLOAD, "names", FORM);
    String USER = "user";
    String WEBSERVICES = "webservices";
    String WEBSERVICES_CLIENT_CONFIG = build(WEBSERVICES, "client-config");
    String WEBSERVICES_CLIENT_CONFIG_ENTRY = build(WEBSERVICES, "client-config", ENTRY);
    String WEBSERVICES_ENDPOINT_CONFIG = build(WEBSERVICES, "endpoint-config");
    String WEBSERVICES_ENDPOINT_CONFIG_ENTRY = build(WEBSERVICES, "endpoint-config", ENTRY);
    String WEBSERVICES_ENTRY = build(WEBSERVICES, ENTRY);
    String WEBSERVICES_FORM = build(WEBSERVICES, FORM);
    String WEBSERVICES_HANDLER_ADD = build(WEBSERVICES, "handler", ADD);
    String WEBSERVICES_HANDLER_CHAIN_ADD = build(WEBSERVICES, "handler-chain", ADD);
    String WEBSERVICES_HANDLER_CHAIN_COLUMN = build(WEBSERVICES, "handler-chain-column");
    String WORKER = "worker";
    String XA_DATA_SOURCE = "xa-data-source";
    String XA_DATA_SOURCE_ADD = build(XA_DATA_SOURCE, ADD);
    String XA_DATA_SOURCE_FORM = build(XA_DATA_SOURCE, FORM);
    String XA_DATA_SOURCE_RUNTIME = "xa-data-source-runtime";
    String XA_DATA_SOURCE_RUNTIME_JDBC_FORM = build(XA_DATA_SOURCE_RUNTIME, JDBC, FORM);
    String XA_DATA_SOURCE_RUNTIME_JDBC_TAB = build(XA_DATA_SOURCE_RUNTIME, JDBC, TAB);
    String XA_DATA_SOURCE_RUNTIME_POOL_FORM = build(XA_DATA_SOURCE_RUNTIME, POOL, FORM);
    String XA_DATA_SOURCE_RUNTIME_POOL_TAB = build(XA_DATA_SOURCE_RUNTIME, POOL, TAB);
