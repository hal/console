...
public interface Ids {
    ...
    // ------------------------------------------------------ ids (a-z)
    // Don't compose IDs by using the build() method,
    // otherwise they cannot be used in annotations.
    ...
    String CACHE_CONTAINER_ENTRY = "cc-entry";
    ...
    String CACHE_CONTAINER_THREAD_POOLS_ENTRY = "cc-thread-pool-async-operations";
    String CACHE_CONTAINER_TRANSPORT = "cc-transport";
    String CACHE_CONTAINER_TRANSPORT_ENTRY = "cc-transport-entry";
    ...
    String EE_SERVICES_ENTRY = "ee-services-entry";
    String EJB3 = "ejb3";
    ...
    String EJB3_APPLICATION_SECURITY_DOMAIN_ENTRY = "ejb3-app-security-domain-entry";
    ...
    String JCA_BOOTSTRAP_CONTEXT_ENTRY = "jca-bootstrap-context-entry";
    ...
    String JCA_CONFIGURATION_ENTRY = "jca-configuration-entry";
    ...
    String JCA_DISTRIBUTED_WORKMANAGER_ENTRY = "jca-distributed-workmanager-entry";
    ...
    String JCA_WORKMANAGER_ENTRY = "jca-workmanager-entry";
    ...
    String JGROUPS_CHANNEL_ENTRY = "jgroups-channel-entry";
    String JGROUPS_CHANNEL_FORK = "fork";
    String JGROUPS_CHANNEL_FORK_ENTRY = "jgroups-channel-entry-fork-entry";
    String JGROUPS_CHANNEL_FORK_PROTOCOL = "fork-protocol";
    String JGROUPS_ENTRY = "jgroups-entry";
    ...
    String JGROUPS_STACK_ENTRY = "jgroups-stack-entry";
    ...
    String JMX = "jmx";
    String JMX_AUDIT_LOG_ENTRY = "jmx-audit-log-entry";
    String JMX_AUDIT_LOG_FORM = "jmx-audit-log-form";
    String JMX_CONFIGURATION_ENTRY = "jmx-configuration-entry";
    String JMX_CONFIGURATION_FORM = "jmx-configuration-form";
    String JMX_REMOTING_CONNECTOR_ENTRY = "jmx-remoting-connector-entry";
    ...
    String JPA_RUNTIME_COLLECTION_ENTRY = "jpa-runtime-collection-entry";
    String JPA_RUNTIME_ENTITY_CACHE_ENTRY = "jpa-runtime-entity-cache-entry";
    ...
    String MAIL_SESSION_ENTRY = "mail-session-entry";
    ...
    String MESSAGING_SECURITY_SETTING_ROLE_ENTRY = "messaging-security-setting-role-entry";
    ...
    String SERVER_STATUS_BOOTSTRAP_ENTRY = "server-runtime-bootstrap-entry";
    String SERVER_STATUS_MAIN_ATTRIBUTES_ENTRY = "server-runtime-main-attributes-entry";
    String SERVER_STATUS_SYSTEM_PROPERTIES_ENTRY = "server-runtime-system-properties-entry";
    ...
    String UNDERTOW_HOST_ENTRY = "undertow-host-entry";
    ...
    String UNDERTOW_SERVER_CONFIGURATION_ENTRY = "undertow-server-configuration-entry";
    ...
    String UNDERTOW_SERVER_LISTENER_ENTRY = "undertow-server-listener-entry";
    ...
    String UNDERTOW_SERVLET_CONTAINER_CONFIGURATION_ENTRY = "undertow-servlet-container-configuration-entry";
    ...
    String WEBSERVICES_CLIENT_CONFIG_ENTRY = "webservices-client-config-entry";
    String WEBSERVICES_ENDPOINT_CONFIG = "webservices-endpoint-config";
    String WEBSERVICES_ENDPOINT_CONFIG_ENTRY = "webservices-endpoint-config-entry";
    String WEBSERVICES_ENTRY = "webservices-entry";
