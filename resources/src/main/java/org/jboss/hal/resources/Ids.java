...
public interface Ids {
    ...
    String ELYTRON_IDENTITY_ATTRIBUTE_MAPPING_ADD = build(ELYTRON_IDENTITY_ATTRIBUTE_MAPPING, ADD_SUFFIX);
    ...
    String ELYTRON_IDENTITY_ATTRIBUTE_MAPPING_TAB = build(ELYTRON_IDENTITY_ATTRIBUTE_MAPPING, TAB_SUFFIX);
    ...
    String ELYTRON_JDBC_REALM_ATTRIBUTE_MAPPING_ADD = build(ELYTRON_JDBC_REALM_ATTRIBUTE_MAPPING, ADD_SUFFIX);
    String ELYTRON_JDBC_REALM_ATTRIBUTE_MAPPING_FORM = build(ELYTRON_JDBC_REALM_ATTRIBUTE_MAPPING, FORM_SUFFIX);
    String ELYTRON_JDBC_REALM_ATTRIBUTE_MAPPING_PAGE = build(ELYTRON_JDBC_REALM_ATTRIBUTE_MAPPING, PAGE_SUFFIX);
    String ELYTRON_JDBC_REALM_ATTRIBUTE_MAPPING_TABLE = build(ELYTRON_JDBC_REALM_ATTRIBUTE_MAPPING, TABLE_SUFFIX);
    ...
    String ELYTRON_LDAP_KEY_STORE_NEW_ITEM_TEMPLATE_ADD = build(ELYTRON_LDAP_KEY_STORE, "new-item-template", ADD_SUFFIX);
    String ELYTRON_LDAP_KEY_STORE_NEW_ITEM_TEMPLATE_FORM = build(ELYTRON_LDAP_KEY_STORE, "new-item-template", FORM_SUFFIX);
    String ELYTRON_LDAP_KEY_STORE_NEW_ITEM_TEMPLATE_TAB = build(ELYTRON_LDAP_KEY_STORE, "new-item-template", TAB_SUFFIX);
    ...
    String ELYTRON_MECHANISM_CONFIGURATIONS_FORM = build(ELYTRON_MECHANISM_CONFIGURATIONS, FORM_SUFFIX);
    String ELYTRON_MECHANISM_CONFIGURATIONS_PAGE = build(ELYTRON_MECHANISM_CONFIGURATIONS, PAGE_SUFFIX);
    String ELYTRON_MECHANISM_CONFIGURATIONS_TABLE = build(ELYTRON_MECHANISM_CONFIGURATIONS, TABLE_SUFFIX);
    ...
    String ELYTRON_MECHANISM_REALM_CONFIGURATIONS_ADD = build(ELYTRON_MECHANISM_REALM_CONFIGURATIONS, ADD_SUFFIX);
    String ELYTRON_MECHANISM_REALM_CONFIGURATIONS_FORM = build(ELYTRON_MECHANISM_REALM_CONFIGURATIONS, FORM_SUFFIX);
    String ELYTRON_MECHANISM_REALM_CONFIGURATIONS_PAGE = build(ELYTRON_MECHANISM_REALM_CONFIGURATIONS, PAGE_SUFFIX);
    String ELYTRON_MECHANISM_REALM_CONFIGURATIONS_TABLE = build(ELYTRON_MECHANISM_REALM_CONFIGURATIONS, TABLE_SUFFIX);
